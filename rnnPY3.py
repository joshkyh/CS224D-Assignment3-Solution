...
import treePY3 as tr
from utilsPY3 import Vocab
...
class RNN_Model():
    ...
    def load_data(self):
        ...
        self.train_data, self.dev_data, self.test_data = tr.simplified_data(10, 100, 200) #700, 100, 200
    ...
    def inference(self, tree, predict_only_root=False):
        ...
        if predict_only_root:
            ...
            node_tensors = tf.concat(axis = 0, values = node_tensors)
    ...
    def add_model(self, node):
        ...
        if node.isLeaf:
            ...
            ### YOUR CODE HERE
            #pdb.set_trace()
            child_tensor = tf.concat(axis = 1, values = [node_tensors[node.left], node_tensors[node.right]])
